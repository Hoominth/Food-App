    ...
    <motion.div className="w-full grid grid-cols-1 md:grid-cols-2 gap-4">
      <div className="flex flex-col items-start justify-start gap-6">
        ...
        <p className="text-textColor text-lg">
          ...
          ipsum eius necessitatibus? Laudantium cum similique, alias animi illum
          aperiam amet labore, accusamus eligendi dolore inventore saepe
          repudiandae numquam, quidem obcaecati?
        </p>
        <motion.button
          {...buttonClick}
