...
const OrderData = ({ index, data, admin }) => {
  ...
  return (
    <motion.div
      ...
      className="w-full flex flex-col items-start justify-start px-3 py-2 border relative border-gray-300 bg-lightOverlay drop-shadow-md rounded-md gap-3"
    >
      <div className="w-full flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <p className="px-2 py-[2px] text-sm text-headingColor font-semibold capitalize rounded-md drop-shadow-md bg-emerald-400">
            {data?.status}
          </p>
